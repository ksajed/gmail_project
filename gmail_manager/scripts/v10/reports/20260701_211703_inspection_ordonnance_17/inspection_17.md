...
- Objet : RenewalCycle(p=17, n=1, status=RECEIVED)
...
- Objet : Ordonnance #17 – Archivée
- Suggestion : Déplacer ce dossier vers le Centre des anomalies ou clôturer les cycles actifs.


## Anomalies détectées
- ⚠️ Ordonnance archivée avec un cycle encore actif.
- ⚠️ Ordonnance archivée : elle ne doit pas apparaître comme urgence normale.